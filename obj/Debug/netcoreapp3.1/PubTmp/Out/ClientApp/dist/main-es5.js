      ...
      _createClass(ModalityCreateComponent, [{
        ...
        value: function getTeachers() {
          ...
          this.http.get('/api/teachers', this.httpOptions).subscribe(function (result) {
            ...
            return _this2.toastr.error('Error Status: ' + error.status);
          });
        }
      }, {
        key: "Save",
        value: function Save() {
          ...
          this.http.post('api/modalities', jData, this.httpOptions).subscribe(function (data) {
            _this3.toastr.success('Data Saved');

            _this3.router.navigate(['/modalities']);
          }, function (error) {
            return _this3.toastr.error('Error Status: ' + error.status);
          });
        }
      }]);
    ...
    function () {
      function ModalityEditComponent(http, router, toastr, route, baseUrl) {
        ...
        http.get(baseUrl + 'api/modalities/' + this.mainId, this.httpOptions).subscribe(function (result) {
          ...
          return _this4.toastr.error('Error Status: ' + error.status);
        });
        this.getTeachers();
      }
      ...
      _createClass(ModalityEditComponent, [{
        ...
        value: function getTeachers() {
          ...
          this.http.get('/api/teachers', this.httpOptions).subscribe(function (result) {
            ...
            return _this5.toastr.error('Error Status: ' + error.status);
          });
        }
      }, {
        key: "ngOnInit",
        ...
        value: function Save() {
          ...
          this.http.put('api/modalities/' + this.mainId, jData, this.httpOptions).subscribe(function (data) {
            _this6.toastr.success('Data Saved');

            _this6.router.navigate(['/modalities']);
          }, function (error) {
            return _this6.toastr.error('Error Status: ' + error.status);
          });
        }
      }]);
      ...
      _createClass(ModalityTableComponent, [{
        ...
        value: function getData() {
          ...
          this.http.get('/api/modalities', this.httpOptions).subscribe(function (result) {
            ...
            return _this7.toastr.error('Error Status: ' + error.status);
          });
        }
      }, {
        key: "edit",
        ...
        value: function remove(id, name) {
          ...
          if (confirm('Are you sure that you want to remove this registry? \r\n Name: ' + name)) this.http["delete"]('/api/modalities/' + id, this.httpOptions).subscribe(function (data) {
            _this8.toastr.success('Completed');

            _this8.getData();
          }, function (error) {
            return _this8.toastr.error('Error Status: ' + error.status);
          });else this.toastr.warning('Action cancelled');
        }
      }]);
      ...
      _createClass(NeighborhoodCreateComponent, [{
        ...
        value: function Save() {
          ...
          this.http.post('api/neighborhoods', jData, this.httpOptions).subscribe(function (data) {
            _this9.toastr.success('Data saved');

            _this9.router.navigate(['/neighborhoods']);
          }, function (error) {
            return _this9.toastr.error('Error Status: ' + error.status);
          });
        }
      }]);
    ...
    function () {
      function NeighborhoodEditComponent(http, router, toastr, route, baseUrl) {
        ...
        http.get(baseUrl + 'api/neighborhoods/' + this.mainId, this.httpOptions).subscribe(function (result) {
          ...
          return _this10.toastr.error('Error Status: ' + error.status);
        });
      }
      ...
      _createClass(NeighborhoodEditComponent, [{
        ...
        value: function Save() {
          ...
          this.http.put('api/neighborhoods/' + this.mainId, jData, this.httpOptions).subscribe(function (data) {
            _this11.toastr.success('Data Saved');

            _this11.router.navigate(['/neighborhoods']);
          }, function (error) {
            return _this11.toastr.error('Error Status: ' + error.status);
          });
        }
      }]);
      ...
      _createClass(NeighborhoodTableComponent, [{
        ...
        value: function getData() {
          ...
          this.http.get('/api/neighborhoods', this.httpOptions).subscribe(function (result) {
            ...
            return _this12.toastr.error('Error Status: ' + error.status);
          });
        }
      }, {
        key: "edit",
        ...
        value: function remove(id, name) {
          ...
          if (confirm('Are you sure that you want to remove this registry? \r\n Name: ' + name)) this.http["delete"]('/api/neighborhoods/' + id, this.httpOptions).subscribe(function (data) {
            _this13.toastr.success("Completed");

            _this13.getData();
          }, function (error) {
            return _this13.toastr.error('Error Status: ' + error.status);
          });else this.toastr.warning('Action Cancelled!');
        }
      }]);
      ...
      _createClass(StudentCreateComponent, [{
        ...
        value: function getModalities() {
          ...
          this.http.get('/api/modalities', this.httpOptions).subscribe(function (result) {
            ...
            return _this14.toastr.error('Error Status: ' + error.status);
          });
        }
      }, {
        ...
        value: function getNeighborhoods() {
          ...
          this.http.get('/api/neighborhoods', this.httpOptions).subscribe(function (result) {
            ...
            return _this15.toastr.error('Error Status: ' + error.status);
          });
        }
      }, {
        key: "Save",
        value: function Save() {
          ...
          this.http.post('api/students', jData, this.httpOptions).subscribe(function (data) {
            _this16.toastr.success('Data Saved');

            _this16.router.navigate(['/students']);
          }, function (error) {
            return _this16.toastr.error('Error Status: ' + error.status);
          });
        }
      }]);
    ...
    function () {
      function StudentEditComponent(http, toastr, router, route, baseUrl) {
        ...
        http.get(baseUrl + 'api/students/' + this.mainId, this.httpOptions).subscribe(function (result) {
          ...
          return _this17.toastr.error('Error Status: ' + error.status);
        });
        this.getModalities();
        this.getNeighborhoods();
      }
      ...
      _createClass(StudentEditComponent, [{
        ...
        value: function getModalities() {
          ...
          this.http.get('/api/modalities', this.httpOptions).subscribe(function (result) {
            ...
            return _this18.toastr.error('Error Status: ' + error.status);
          });
        }
      }, {
        key: "getNeighborhoods",
        value: function getNeighborhoods() {
          ...
          this.http.get('/api/neighborhoods', this.httpOptions).subscribe(function (result) {
            ...
            return _this19.toastr.error('Error Status: ' + error.status);
          });
        }
      }, {
        key: "ngOnInit",
        ...
        value: function Save() {
          ...
          this.http.put('api/students/' + this.mainId, jData, this.httpOptions).subscribe(function (data) {
            _this20.toastr.success('Data Saved');

            _this20.router.navigate(['/students']);
          }, function (error) {
            return _this20.toastr.error('Error Status: ' + error.status);
          });
        }
      }]);
      ...
      _createClass(StudentTableComponent, [{
        ...
        value: function getData() {
          ...
          this.http.get('/api/students', this.httpOptions).subscribe(function (result) {
            ...
            return _this21.toastr.error('Error Status: ' + error.status);
          });
        }
      }, {
        key: "edit",
        ...
        value: function remove(id, name) {
          ...
          if (confirm('Are you sure that you want to remove this registry? \r\n Name: ' + name)) this.http["delete"]('/api/students/' + id, this.httpOptions).subscribe(function (data) {
            _this22.toastr.success('Completed');

            _this22.getData();
          }, function (error) {
            return _this22.toastr.error('Error Status: ' + error.status);
          });else this.toastr.warning('Action Cancelled');
        }
      }]);
      ...
      _createClass(TeacherCreateComponent, [{
        ...
        value: function Save() {
          ...
          this.http.post('api/teachers', jData, this.httpOptions).subscribe(function (data) {
            _this23.toastr.success('Data Saved');

            _this23.router.navigate(['/teachers']);
          }, function (error) {
            return _this23.toastr.error('Error Status: ' + error.status);
          });
        }
      }]);
      ...
      _createClass(TeacherEditComponent, [{
        ...
        value: function Save() {
          ...
          this.http.put('api/teachers/' + this.mainId, jData, this.httpOptions).subscribe(function (data) {
            _this25.toastr.success('Data Saved');

            _this25.router.navigate(['/teachers']);
          }, function (error) {
            return _this25.toastr.error('Error Status: ' + error.status);
          });
        }
      }]);
      ...
      _createClass(TeacherTableComponent, [{
        ...
        value: function getData() {
          ...
          this.http.get('/api/teachers', this.httpOptions).subscribe(function (result) {
            ...
            return _this26.toastr.error('Error Status: ' + error.status);
          });
        }
      }, {
        key: "edit",
        ...
        value: function remove(id, name) {
          ...
          if (confirm('Are you sure that you want to remove this registry? \r\n Name: ' + name)) this.http["delete"]('/api/teachers/' + id, this.httpOptions).subscribe(function (data) {
            _this27.toastr.success('Completed');

            _this27.getData();
          }, function (error) {
            return _this27.toastr.error('Error Status: ' + error.status);
          });else this.toastr.warning('Action Cancelled');
        }
      }]);
      ...
      _createClass(UserCreateComponent, [{
        ...
        value: function Save() {
          ...
          this.http.post('api/users', jData, this.httpOptions).subscribe(function (data) {
            _this28.toastr.success('Data Saved');

            _this28.router.navigate(['/users']);
          }, function (error) {
            return _this28.toastr.error('Error Status: ' + error.status);
          });
        }
      }]);
      ...
      _createClass(UserEditComponent, [{
        ...
        value: function Save() {
          ...
          this.http.put('api/users/' + this.mainId, jData, this.httpOptions).subscribe(function (data) {
            _this30.toastr.success('Data Saved');

            _this30.router.navigate(['/users']);
          }, function (error) {
            return _this30.toastr.error('Error Status: ' + error.status);
          });
        }
      }]);
      ...
      _createClass(UserTableComponent, [{
        ...
        value: function getData() {
          ...
          this.http.get('/api/users', this.httpOptions).subscribe(function (result) {
            ...
            return _this31.toastr.error('Error Status: ' + error.status);
          });
        }
      }, {
        key: "edit",
        ...
        value: function remove(id, name) {
          ...
          if (confirm('Are you sure that you want to remove this registry? \r\n Name: ' + name)) this.http["delete"]('/api/users/' + id, this.httpOptions).subscribe(function (data) {
            _this32.toastr.success('Completed');

            _this32.getData();
          }, function (error) {
            return _this32.toastr.error('Error Status: ' + error.status);
          });else this.toastr.warning('Action Cancelled');
        }
      }]);
